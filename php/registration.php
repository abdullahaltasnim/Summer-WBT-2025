...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($name_err) && empty($email_err) && empty($username_err) &&
        ...
        empty($gender_err) && empty($dob_err)) {
  ...
  <div style="float: right;">
    ...
    <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post"
      ...
      <fieldset>
        ...
        Name:
        <input type="text" name="name" value="<?php echo $name; ?>" style="width: 100%;"><br>
        ...
        User Name:
        <input type="text" name="username" value="<?php echo $username; ?>" style="width: 100%;"><br>
        ...
        Confirm Password:
        <input type="password" name="confirm_password" style="width: 100%;"><br>
        ...
        Date of Birth:
        <input type="date" name="dob" value="<?php echo $dob; ?>" style="width: 100%;"><br>
